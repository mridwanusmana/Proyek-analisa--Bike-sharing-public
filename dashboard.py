...
with st.sidebar: 
    st.image("https://github.com/mridwanusmana/Proyek-analisa--Bike-sharing-public/blob/facef1599963f131f47e17d8524b319067622b4d/dashboard/logo.png")
...
st.caption('Copyright © Muhamad Ridwan Usmana 2024')